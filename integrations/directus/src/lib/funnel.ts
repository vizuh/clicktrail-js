...
const LEAD_EVENT_NAMES = ['lead_created'] as const;
const QUALIFIED_EVENT_NAME = 'lead_qualified';
 ...
 * - 'lead_created' counts as a lead; only 'lead_qualified' counts as
 *   qualified; only 'sale' counts as a
