...
export const MODULE_NAME = '@clicktrail/nuxt';
...
export const CLIENT_PLUGIN_ENTRY = '@clicktrail/nuxt/plugin';

/** Nitro server-handler entry registered via `addServerHandler`. */
export const PROXY_HANDLER_ENTRY = '@clicktrail/nuxt/runtime/proxy.handler';
